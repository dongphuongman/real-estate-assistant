...
This repo (`AleksNeStu/ai-real-estate-assistant`) is **frozen**. Active development moved to `NestLab-Tech/ai-real-estate-assistant` (private). The public repo stays unarchived and must remain healthy for demo purposes.
