...
describe("UsagePage", () => {
  ...
  describe("Loading State", () => {
    it("shows skeleton cards while loading", () => {
      mockGetUserActivitySummary.mockImplementation(
        () => new Promise(() => {})
      );
      mockGetUserActivityTrends.mockImplementation(
        () => new Promise(() => {})
      );
  ...
  describe("Error Handling", () => {
    it("displays error message on API failure", async () => {
      mockGetUserActivitySummary.mockRejectedValue(
        new Error("Failed to load usage data")
      );
      mockGetUserActivityTrends.mockRejectedValue(
  ...
  describe("Privacy Compliance", () => {
    it("does not expose user IDs in the UI", async () => {
      ...
      const pageContent = screen.getByText("Usage Dashboard").parentElement
