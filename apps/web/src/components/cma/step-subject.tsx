      ...
      {subjectProperty && (
        <div className="border rounded-lg p-4 bg-primary/5">
          <div className="flex items-start justify-between">
            <div>
              <h3 className="font-medium">Selected Subject Property</h3>
              <p className="text-sm text-muted-foreground mt-1">
                {subjectProperty.address || subjectProperty.city}
                {subjectProperty.district ? `, ${subjectProperty.district}` : ''}
              </p>
            </div>
            <span className="text-xs bg-primary/10 text-primary px-2 py-1 rounded">Selected</span>
          </div>
