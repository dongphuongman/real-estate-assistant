...
This module provides SQLite-based storage for context window optimization metrics,
...
def init_context_metrics_db(db_path: Path = CONTEXT_METRICS_DB_PATH) -> None:
...
def get_usage_summary(
    ...
    return {
        ...
        "total_costs_by_provider": get_total_costs(db_path=db_path, days=days),
